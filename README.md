...
# 🤑 my_Expense <a name="about-project"></a>

 > my_Expense" is a simple app that allows you to tract yur expenses. It uses React Hooks, state, props, and array mapping to allow for the creation and deletion of notes.
...
```sh
  git clone https://github.com/abenaTenkorang/my_Expense.git
  cd my_Expense
```
